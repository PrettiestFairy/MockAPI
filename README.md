...
This project develops an operating system for Windows. There is a `pywin32` module package in the `.requirements.basic.txt` . Please ignore this module for mac and linux.
